...
document.querySelector("#Languagecookie-btn1").addEventListener("click", () => {
    setCookie("Languagecookie", true, 30);
    location.reload();
})
document.querySelector("#Languagecookie-btn2").addEventListener("click", () => {
    setCookie("Languagecookie", false, 30);
    location.reload();
})
...
cookieMessage = () => {
    if(!getCookie("cookie"))document.querySelector("#cookieBanner").style.display = "flex";
}
...
window.addEventListener('load', () => {
    ...
    if(cookieValue === "true"){
        ...
        Analytics.src = "javascript/googleAnalytics.js";
